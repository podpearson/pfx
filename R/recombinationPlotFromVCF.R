...
# recombinationPlotFromVCF("/data/galton/users/rpearson/zam/delivery/plasmodium/7g8_gb4_wk_flow_I_combined_BC_calls_at_all_k.decomp.vcf", "MAL4", GTsToIntMapping=c("0/0"=1, "1/1"=2), keepPASSvariantsOnly=TRUE)
# dev.off()
