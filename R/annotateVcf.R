...
#      fixed=fixed(exptData(vcf)[["header"]]),
      ...
      INFO=rbind(
        ...
        DataFrame(Number="1", Type="Float", Description="Number of copies aligned with the first consensus pattern", row.names="RepeatCopies1"),
        DataFrame(Number="1", Type="Integer", Description="Period size of the first repeat", row.names="RepeatPeriod1"),
        DataFrame(Number="1", Type="Integer", Description="Alignment score of the first repeat", row.names="RepeatScore1"),
